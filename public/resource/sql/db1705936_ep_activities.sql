...
--
-- Table structure for table `ep_activities`
--

DROP TABLE IF EXISTS `ep_activities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ep_activities` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `ep_activities`
--

LOCK TABLES `ep_activities` WRITE;
/*!40000 ALTER TABLE `ep_activities` DISABLE KEYS */;
/*!40000 ALTER TABLE `ep_activities` ENABLE KEYS */;
UNLOCK TABLES;
