...
--
-- Table structure for table `ep_players`
--

DROP TABLE IF EXISTS `ep_players`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ep_players` (
...
--
-- Dumping data for table `ep_players`
--

LOCK TABLES `ep_players` WRITE;
/*!40000 ALTER TABLE `ep_players` DISABLE KEYS */;
INSERT INTO `ep_players` VALUES (1,'Tyantreides Caitsith','Chris','{\"classes\":{1:94,2:90,3:76}}','{\"jobs\":{1:93,9:94,6:76}}',2271502,'');
/*!40000 ALTER TABLE `ep_players` ENABLE KEYS */;
UNLOCK TABLES;
